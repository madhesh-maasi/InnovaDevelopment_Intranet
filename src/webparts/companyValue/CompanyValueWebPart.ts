...
export interface ICompanyValueWebPartProps {
  description: string;
}

export default class CompanyValueWebPart extends BaseClientSideWebPart<ICompanyValueWebPartProps> {
  public render(): void {
    const element: React.ReactElement<ICompanyValueProps> = React.createElement(
      CompanyValue,
      {
